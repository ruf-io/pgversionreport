      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            CVEs fixed after {data.version.major}.{data.version.minor}
          </p>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            bugs fixed after {data.version.major}.{data.version.minor}
          </p>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          <div className="text-4xl font-bold">{data.performanceImprovements.length}</div>
          <p className="mt-1 text-sm text-muted-foreground">improvements after {data.version.major}.{data.version.minor}</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-md font-medium">Features</CardTitle>
          <CircleFadingArrowUp className="h-6 w-6 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-4xl font-bold">{data.features.length}</div>
          <p className="mt-1 text-sm text-muted-foreground">new features after {data.version.major}.{data.version.minor}</p>
        </CardContent>
      </Card>
    </div>
  );
