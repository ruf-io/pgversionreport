    ...
    cell: ({ row }) => (
      <CollapsibleDataItem title={row.getValue("title")}>
        <div className="prose prose-sm">
          <p>
            Fixed in: <InlineCode>{row.original.fixedIn}</InlineCode>{" "}
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem><a href={generatePgDeepLink(
                row.original.fixedIn,
                row.original.title
              )}
              target="_blank">View in PG Docs</a></DropdownMenuItem>
            <DropdownMenuItem><a href={`https://www.cve.org/CVERecord?id=${encodeURIComponent(
                row.original.cve
              )}`}
              target="_blank">View on CVE.org</a></DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
    },
